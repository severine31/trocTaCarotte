...
CMD composer install ; yarn install ; yarn encore dev ; bin/console doctrine:database:create ; bin/console make:migration ; bin/console doctrine:migrations:migrate ; php -S 0.0.0.0:8000 -t public/
EXPOSE 8000